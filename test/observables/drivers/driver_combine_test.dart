...
void main() {
  ...
  test('`Driver.combine` emit latest combined value when a child emit', () async {
  ...
  test('`Driver.combine` dispose observation will dispose all children observations', () {
  ...
  test('`Driver.combine` will not emit data after observation disposed', () async {
